...
function myFunction() {
  ...
  if (x.className === "topnav") {
    ...
    <div class="row">
      <div class="column">
        <img src="Images/Funcroom1.jpg" style="width:100%" alt="Funtion room">
      </div>
      <div class="column">
        <img src="Images/Funcroom2.jpg" style="width:100%" alt="Funtion room">
      </div>
      <div class="column">
        <img src="Images/Funcroom3.jpg" style="width:100%" alt="Funtion room">
      </div>
      <div class="column">
        <img src="Images/Funcroom4.jpg" style="width:100%" alt="Funtion room">
      </div>
    </div>
